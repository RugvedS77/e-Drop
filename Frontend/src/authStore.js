...
  // --- 4. Update User Data Action (The Missing Piece) ---
  /**
   * Updates local user state (and localStorage) with partial new data.
   * @param {Object} newUserData - Partial object like { full_name, email, phone }
   */
  setUser: (newUserData) => {
    set((state) => {
      const updatedUser = { 
...
      // Also update localStorage to persist changes across sessions/reloads
